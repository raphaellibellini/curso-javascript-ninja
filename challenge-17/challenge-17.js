(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Raphaelli Bellini'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/g, 'juiz-forano'));
  ...
  */
  ...
  function getMonthNumber(monthName) {
    var months = {
      janeiro: '01',
      fevereiro: '02',
      'março': '03', // Tem que ter aspas por ter o cidilha
      abril: '04',
      maio: '05',
      junho: '06',
      julho: '07',
